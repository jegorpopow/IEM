...
Project for an ITMO Devtools compilers course.
...
To invoke ¡compilador! run:

```bash 
cargo run <path-to-src> # Compile to <path-to-src>.obj 
cargo run --bin interpret <path-to-src> # Run 
```
